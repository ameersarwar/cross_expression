...
These are the gene pairs showing statistically significant cross-expression across our tissue slice. In total, you should have 52 pairs (out of 8778 possible pairs that can be formed using 133 genes in our panel).
