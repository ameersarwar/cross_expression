...
<img width="400" alt="Screenshot 2024-07-04 at 2 32 29 AM" src="https://github.com/ameersarwar/cross_expression/assets/174621170/e29da77f-e57e-4b34-9bf9-41e95b3e0adf">
...
Like the two cross-expression functions, the `bullseye_scores` consider both cases. Unlike these functions, however, the `bullseye_scores` present both directions as outputs, making its size here twice as large those of the two cross-expression functions. Thus, the user can average the directional information or take the minimum, etc., if a unidirectional output is desired.
